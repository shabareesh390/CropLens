...
export function Topbar({ onMenu, user }: { onMenu: () => void; user?: User | null }) {
  ...
  return (
    <header className="sticky top-0 z-30 h-[64px] flex items-center gap-3 px-5 md:px-8 border-b"
      ...
      <button className="relative p-2 rounded-lg hover:bg-white/60" aria-label="Notifications">
        <Bell size={18} />
